namespace NServiceBus
{
    ...
    public static class RavenDbGatewayDeduplicationSettingsExtensions
    {
        ...
        [ObsoleteEx(
            ...
            RemoveInVersion = "8.0.0",
            TreatAsErrorFromVersion = "7.0.0")]
        public static PersistenceExtensions<RavenDBPersistence> UseDocumentStoreForGatewayDeduplication(this PersistenceExtensions<RavenDBPersistence> cfg, Func<IReadOnlySettings, IDocumentStore> storeCreator)
        {
            throw new NotImplementedException();
        }
        ...
        [ObsoleteEx(
            ...
            RemoveInVersion = "8.0.0",
            TreatAsErrorFromVersion = "7.0.0")]
        public static PersistenceExtensions<RavenDBPersistence> UseDocumentStoreForGatewayDeduplication(this PersistenceExtensions<RavenDBPersistence> cfg, Func<IReadOnlySettings, IServiceProvider, IDocumentStore> storeCreator)
        {
            throw new NotImplementedException();
        }
    }
