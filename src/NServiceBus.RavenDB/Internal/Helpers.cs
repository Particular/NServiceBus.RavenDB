namespace NServiceBus.RavenDB.Internal
{
    ...
    class Helpers
    {
        ...
        public static IDocumentStore CreateDocumentStoreByConnectionStringName(ReadOnlySettings settings, params string[] connectionStringNames)
        {
            ...
            if (!string.IsNullOrWhiteSpace(connectionStringName))
            {
                ...
                ApplyDocumentIdConventions(settings, docStore);
    ...
    <add name=""NServiceBus.Persistence"" connectionString=""http://localhost:9090"" />
        ...
        /// <summary>
        /// Applies DocumentId conventions to <see cref="DocumentStore" />, which should be done regardless of whether
        /// the docStore is provided or generated by NServiceBus.
        /// </summary>
        public static void ApplyDocumentIdConventions(ReadOnlySettings settings, IDocumentStore documentStore)
        {
            var conventions = new DocumentIdConventions(documentStore, settings.GetAvailableTypes());
            documentStore.Conventions.FindTypeTagName = conventions.FindTypeTagName;
        }

        /// <summary>
        /// Apply the NServiceBus conventions to a <see cref="DocumentStore" />, which should only be done
        /// for a store generated by NServiceBus.
        /// </summary>
