namespace NServiceBus.RavenDB.Tests
{
    ...
    public class When_validating_RavenDb_prerelease_versions
    {
        ...
        {
            Assert.Throws<Exception>(() => MinimumRequiredRavenDbServerVersion.Validate(serverVersion, requiredVersion));
        }
        ...
        {
            Assert.DoesNotThrow(() => MinimumRequiredRavenDbServerVersion.Validate(serverVersion, requiredVersion));
        }
    }
}